      ...
      <body className={`${inter.className} antialiased`}>
        <WalletProviders>
          <div className="min-h-screen bg-bg flex flex-col">
            ...
            <footer className="py-6 flex justify-center gap-6 text-secondary">
              <a
                href="https://github.com/digital-forest-space/obligation-free-credit-calculator"
                target="_blank"
              ...
              <a
                href="https://x.com/DigitalForestSp"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary transition-colors"
